from scraping_sites.sites import *
import os
...
class News():
    def __init__(self):
        self.dict_site ={}
        self.all_sites=['globo','bolavip','r7','cnn','veja']
        self.screen=0
        self.kill=False
    ...
    def _receive_command(self,valid_commands,timeout=10):
    ...
    def main_loop(self):
        while True:
            ...
            match self.screen:
                case 0:
                     print('##################### SEJA BEM VINDO AO NEWS NEWS. #####################')
